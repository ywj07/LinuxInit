...
#Author: yeweijie
#Time:2017-08-16 16:45:31
#Name:createusers_dev.sh
#Version:V1.0
#Description:用于---- 创建研发组用户,若用户存在，也可以用于修改用户密码，以及修改用户所属组
...
if  [ ! -f ${userfile} ] 
    then  printf "请先创建用户列表文件 userlist_dev ： ${userfile} "
    exit 1
fi
return 0
}
