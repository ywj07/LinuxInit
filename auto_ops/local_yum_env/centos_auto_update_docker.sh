#!/bin/bash
# base value
YUM_SITE="rsync://mirrors.tuna.tsinghua.edu.cn/docker/"
LOCAL_PATH="/var/www/html/richstonedt_mirrors/docker/"
LOCAL_VER='yum'
BW_limit=1024
LOCK_FILE="/var/log/yum_docker.pid"
RSYNC_PATH=""
...
echo -e "\nupdate successfully" >> /var/www/html/richstonedt_mirrors/docker/docker_update.log

echo -e "cur_datetime:$cur_datetime\n" >> /var/www/html/richstonedt_mirrors/docker/docker_update.log
