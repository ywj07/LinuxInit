...
LOCAL_VER='6'
BW_limit=1024
LOCK_FILE="/var/log/yum_server_epel_6.pid"
RSYNC_PATH=""
...
echo -e "\nupdate successfully" >> /var/www/html/richstonedt_mirrors/epel/epel_6_update.log
echo -e "cur_datetime:$cur_datetime\n" >> /var/www/html/richstonedt_mirrors/epel/epel_6_update.log
