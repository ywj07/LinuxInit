#!/bin/bash
# base value
YUM_SITE="rsync://mirrors.tuna.tsinghua.edu.cn/ELK/"
LOCAL_PATH="/var/www/html/richstonedt_mirrors/ELK/"
LOCAL_VER='yum'
BW_limit=1024
LOCK_FILE="/var/log/yum_elk.pid"
RSYNC_PATH=""
...
echo -e "\nupdate successfully" >> /var/www/html/richstonedt_mirrors/ELK/ELK_update.log

echo -e "cur_datetime:$cur_datetime\n" >> /var/www/html/richstonedt_mirrors/ELK/ELK_update.log
