...
wget http://192.168.6.14:8080/cdh/5.11/cloudera-manager-server-5.11.1-1.cm5111.p0.9.el6.x86_64.rpm
rpm -ivh cloudera-manager-server-5.11.1-1.cm5111.p0.9.el6.x86_64.rpm
